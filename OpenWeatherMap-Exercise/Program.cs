...
namespace OpenWeatherMap_Exercise
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please enter your API Weather key!");
            var api = Console.ReadLine();
            // TODO: Ask the user for their city name and store that in a variable called "city_name"
            Console.WriteLine("What City or Town do you currently live in!");
           ...
           var weatherParse = JObject.Parse(weatherResponse).GetValue("main").ToString();
